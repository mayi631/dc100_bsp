...
#if CONFIG_DSI_LY030BXMS_480X640_NULL_2LANE_60FPS
#undef PANEL_WIDTH
#undef PANEL_HEIGHT
...
#if (CONFIG_PANEL_HX8394 == 1 || CONFIG_PANEL_ILI9488 == 1 || CONFIG_PANEL_OTA7290B == 1 || CONFIG_DSI_LY030BXMS_480X640_NULL_2LANE_60FPS == 1)
    .u8VoCnt = 1,
#else
    .u8VoCnt = 0,
#endif
